...
const products = [
  { name: 'Ireland Fake ID — Scannable Replica', img: '/images/ireland.jpg' },
  { name: 'Ireland Fake ID (Polycarbonate)', img: '/images/ireland.jpg' },
]
...
export default function IrelandProductsPage() {
  return (
    <>
      <SiteHeader active="Buy Fake ID" />
      <main>
        <PageHeader title="IRELAND IDs" />
        <div className="products-page shell">
          ...
          <section aria-labelledby="ie-heading">
            <h2 id="ie-heading" className="country-section-title">🇮🇪 Ireland — Irish ID Cards</h2>
