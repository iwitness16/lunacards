...
const products = [
  { name: 'France Fake ID — Scannable Replica', img: '/images/france.jpg' },
  { name: 'France Fake ID (Polycarbonate)', img: '/images/france.jpg' },
]
      ...
      <main>
        ...
        <div className="products-page shell">
          ...
          <section aria-labelledby="fr-heading">
            <h2 id="fr-heading" className="country-section-title">🇫🇷 France — Carte Nationale d&apos;Identité</h2>
